  ...
  return (
    ...
    <ImageBackground source={blue6} imageStyle={style.image} resizeMode="cover" style={style.page}>
      ...
      <View>
          ...
          <Text style={style.text}>Test your new vocab skills. 
         Select 10 words from your list of 50 to test your knowledge. For each 100% grade, earn a token. 
         50 tokens and you'll be a vocab master! </Text>
