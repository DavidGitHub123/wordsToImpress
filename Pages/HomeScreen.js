import { View, Image, Text, StyleSheet, ScrollView, SafeAreaView, ImageBackground } from 'react-native';
...
export default function HomeScreen({ navigation }) {
  ...
  return (
      ...
      <ImageBackground source={circles} imageStyle={style.image} resizeMode="cover" style={style.page}>

      <View style={style.page}>

      <View style={style.topHeader}>
        <MyProgressButton navigation={navigation} title="MyProgress" destination="MyList"/>
      ...
      <View style={style.header}>
        ...
        <View style={style.heroHeader}>
          <Text style={style.headLine}>Build Your Vocabulary PROWESS</Text>
          <Image style={style.imageHeader} source={logo} />
          {/* <Image style={style.imageHeader} source={require('../assets/logo.jpg')} /> */}
        </View>

        <View>
          <Text style={style.subHead}>With an AI solution to master an impressive vocabulary!</Text>
