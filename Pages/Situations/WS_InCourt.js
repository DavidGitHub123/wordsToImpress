...
export default function WS_InCourt({ navigation }) {
        ...
        <View style={style.component}>
          <View style={style.screen}>
            <Text style={style.subHead}>Catch-22</Text>
              ...
              <Text style={style.space}>
                <Text style={style.title}>Def: </Text>
                <Text style={style.text}>Impossible situation with contradictory options.</Text>
              </Text>
              <Text style={style.space}>
                <Text style={style.title}>Sentence: </Text>
        ...
        <View style={style.component}>
          <View style={style.screen}>
            <Text style={style.subHead}>Defamation</Text>
              ...
              <Text style={style.space}>
                <Text style={style.title}>Def: </Text>
                <Text style={style.text}>False, baseless attacks on person's reputation.</Text>
              </Text>
              <Text style={style.space}>
                <Text style={style.title}>Sentence: </Text>
        ...
        <View style={style.component}>
          <View style={style.screen}>
            <Text style={style.subHead}>Fabulist</Text>
              ...
              <Text style={style.space}>
                <Text style={style.title}>Def: </Text>
                <Text style={style.text}>Liar; someone who tells outrageously untrue stories.</Text>
              </Text>
              <Text style={style.space}>
                <Text style={style.title}>Sentence: </Text>
  ...
  return (
    ...
    <ImageBackground source={courthouse} imageStyle={style.image} resizeMode="cover" style={style.page}>
