...
const AppButton = ({ onPress, icon, title }) => (
  ...
  // const image = source = require('../../assets/Backgrounds/boss.jpg')
...
const Aberration = () => {
      ...
      <View style={style.component}>
        <View style={style.screen}>
          <Text style={style.subHead}>Beleaguered</Text>
            ...
            <Text style={style.space}>
              <Text style={style.title}>Def: </Text>
              <Text style={style.text}>Embattled; constantly confronted with obstacles.</Text>
            </Text>
            <Text style={style.space}>
              <Text style={style.title}>Sentence: </Text>
      ...
      <View style={style.component}>
        <View style={style.screen}>
          <Text style={style.subHead}>Narcissistic</Text>
            ...
            <Text style={style.space}>
              <Text style={style.title}>Sentence: </Text>
              <Text style={style.text}>Self-promotion is one thing; but the </Text>
  ...
  return (
    ...
    <ImageBackground source={boss3} imageStyle={style.image} resizeMode="cover" style={style.page}>
