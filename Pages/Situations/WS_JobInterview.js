      ...
      <View style={style.screen}>
        <Text style={style.subHead}>Baccalaureate</Text>
          ...
          <Text style={style.space}>
            ...
            <Text style={style.text}>Degree awarded upon completion of an undergraduate program.</Text>
          </Text>
          <Text style={style.space}>
...
const Deprecate = () => {
    ...
    <View style={style.component}>
      <View style={style.screen}>
        <Text style={style.subHead}>Deprecate</Text>
          ...
          <Text style={style.space}>
            <Text style={style.title}>Def: </Text>
            <Text style={style.text}>To belittle; disapproval of something.</Text>
          </Text>
          <Text style={style.space}>
            <Text style={style.title}>Sentence: </Text>
        ...
        <View style={style.component}>
          <View style={style.screen}>
            <Text style={style.subHead}>Fait Accompli</Text>
              ...
              <Text style={style.space}>
                <Text style={style.title}>Def: </Text>
                <Text style={style.text}>Something undertaken and already concluded.</Text>
              </Text>
              <Text style={style.space}>
                <Text style={style.title}>Sentence: </Text>
        ...
        <View style={style.component}>
          <View style={style.screen}>
            <Text style={style.subHead}>Imbue</Text>
              ...
              <Text style={style.space}>
                <Text style={style.title}>Def: </Text>
                <Text style={style.text}>To saturate or flow throughout by absorption.</Text>
              </Text>
              <Text style={style.space}>
                <Text style={style.title}>Sentence: </Text>
  ...
  return (
    ...
    <ImageBackground source={jobinterview} imageStyle={style.image} resizeMode="cover" style={style.page}>
