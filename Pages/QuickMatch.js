...
export default function StackIt({ navigation }) {
  ...
  return (
    ...
    <ImageBackground source={blue9} imageStyle={style.image} resizeMode="cover" style={style.page}>

      <View>
          <Text style={style.header}>QuickMatch</Text>
          <Text style={style.text}>Test your knowledge and swiping agility. Match the definitions between 
           the two columns as fast as you can. Score 100% in less than 60 seconds and earn a token. 
           50 tokens you'll be a vocab master!</Text>
      </View>
      ...
      <View>
        ...
        <NavButton navigation={navigation} title="Play Game" destination="Quiz"/>
