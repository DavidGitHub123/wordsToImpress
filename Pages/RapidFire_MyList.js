...
export default function RapidFire_MyListMyList({ navigation }) {
  ...
  return (
    ...
    <LinearGradient
      ...
      <View>
        <Text style={style.text}>After word has been correctly identified 10 times, word is moved into your 
            mastery category. Master all words in your list, begin a new list of 50 words.</Text>
        <Text style={style.textYellow}>Unmastered Words (x/50)</Text>
      </View>
