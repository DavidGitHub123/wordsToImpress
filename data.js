...
export default [
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: "Assisting a plan or activity.",
...

  {
    ...
    Longdef: "Julie found the book's recounting of the serial murders abhorrent.",
...

  {
    ...
    Word: 'Abjured',
    Pronunciation: 'ab-JOOR ed',
    PartofSpeech: 'v',
    Shortdef: "To renounce or reject one's word.",
    Longdef: "After soul-searching following his financial problems, Brad abjured drinking and gambling.",
...

  {
    ...
    Longdef: "The Assembly was presented with a petition signed by the world's aboriginal peoples.",
...

  {
    ...
    Longdef: "Although it was the astronauts' failure that drew media attention, the abortive mission had other problems.",
...

  {
    ...
    Longdef: "Despite the hardships of his abstemious way of life, the monk believed he had chosen the correct path.",
...

  {
    ...
    Longdef: "Scientists may understand Einstein's theories, but for most they remain abstruse ideas.",
    syn: [
      "Esoteric",
      "Arcane",
      "Cryptic",
...

  {
    ...
    SocialSituation: '',
    Word: 'Accentuates',
    Pronunciation: 'ak-SEN-choo-ates',
    PartofSpeech: 'v',
...

  {
    ...
    Longdef: "After a prolonged strike, the representatives finally reached an accord acceptable to both sides.",
...

  {
    ...
    Longdef: "Enchanted by grand-fatherhood, Hank gave over to complete acquiescence with little Laura.",
    syn: [
      "agreement",
      "consent",
      "acceptance",
...

  {
    ...
    SocialSituation: '',
    Word: 'Adages',
    Pronunciation: 'AD-ijs',
    PartofSpeech: 'n',
    Shortdef: "Short sayings of wisdom.",
...

  {
    ...
    Longdef: "Hans, adept at crossword puzzles, sometimes seems to have memorized the dictionary.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Skillful use of one's hands or body.",
...

  {
    ...
    Longdef: "The nurse's work among the poor seemed rooted in a deeper agape.",
...

  {
    ...
    Longdef: "I don't want to aggrandize myself, but I did lead my sales team to triple sales last quarter.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Showing similar features or quality.",
...

  {
    ...
    Longdef: "There are rumors the project will be expensive, but these figures allay that fear.",
...

  {
    ...
    Longdef: "I am aware of the incident to which you allude, but you have been misinformed.",
    syn: [
      "Refer to",
      "Imply",
      "Suggest",
...

  {
    ...
    Longdef: "The two boards voted to amalgamate the firms into one as soon as possible.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Unclear; offering differing interpretations.",
...

  {
    ...
    Longdef: "Jack spoke to everyone at the party; he came across as quite an amiable host.",
...

  {
    ...
    Longdef: "In the end, we find that war is not always for the right, but far too often an amoral exercise.",
...

  {
    ...
    Longdef: "He did not make reasoned arguments in his defense, but rather an amorphous collection of unsupported claims.",
    syn: [
      "shapeless",
      "formless",
      "unstructured",
...

  {
    ...
    Longdef: "That 19th century anachronism should not exist in a book claiming to be the origin story of the U.S. Native Americans.",
    syn: [
      "anomaly",
      "relic",
      "throwback",
...

  {
    ...
    Longdef: "Historically, the American expansion westward is analogous to the Russian expansion across Siberia.",
...

  {
    ...
    Longdef: "The ambassador warned us not to discuss sanctions, that subject was anathema to his government",
    syn: [
      "Curse",
      "Abomination",
      "Abhorrence",
...

  {
    ...
    Longdef: "He took pride in his work, even though his duties were ancillary to the director.",
...

  {
    ...
    Longdef: "The chairman's anecdote was amusing, but they are hardly the stuff of leadership.",
    syn: [
      "story",
      "tale",
      "narrative",
...

  {
    ...
    Longdef: "After being critized he came to harbor animosity toward his supervisor.",
    syn: [
      "hostility",
      "hatred",
      "enmity",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Feelings of strong revulsion or dislike.",
    Longdef: "I'm afraid my antipathy for  opera won't be changed by a single night even at the Paris opera house.",
...

  {
    ...
    Longdef: "Early American found Poor Richard's Almanac to be a rich repository of wit, forecasts, and aphorisms.",
...

  {
    ...
    Longdef: "The story of Shakespeare having shared a mistress with Richard Burbage is almost certainly apocryphal.",
...

  {
    ...
    Longdef: "Apropos of our vacation, it occurs to me that we haven't selected a hotel in Honolulu.",
...

  {
    ...
    Longdef: "Barbara, an ardent stamp collector, has the most impressive collection of French stamps.",
    syn: [
      "passionate",
      "enthusiastic",
      "fervent",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Person who chooses a life self-denial.",
...

  {
    ...
    Longdef: "I will not allow you to cast an aspersion on a man whose career has been so distinguished.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Assiduously',
    Pronunciation: 'ih-SID-joo-us-lee ly',
    PartofSpeech: 'a',
...

  {
    ...
    Longdef: "Milton found keeping pace with avant-garde work in sculpture both challenging and rewarding.",
...

  {
    ...
    Longdef: "Although he was successful, avarice was not in his nature, donating much of his money.",
...

  {
    ...
    Longdef: "He suggested Shakespeare had been written by Queen Elizabeth, as if that balderdash would help his cause.",
    syn: [
      "nonsense",
      "gibberish",
      "absurdity",
...

  {
    ...
    Longdef: "His baneful influence on the younger men was the cause of all the misdeeds we are examining.",
...

  {
    ...
    Longdef: "The defense attorney subjected the witness to a barrage of questions about that night.",
...

  {
    ...
    Longdef: "Don became overbearing and belligerent with his employees, causing many to resign.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Bequeathed',
    Pronunciation: 'bee-QUEETH ed',
    PartofSpeech: 'v',
    Shortdef: 'Bestowed by means of a will.',
    Longdef: "It is the language we speak, bequeathed to us by Byron and Shakespeare that binds us to the English.",
...

  {
    ...
    Longdef: "We beseech you, Mr. Prime Minister: think twice before committing the lives of so many of our countrymen.",
    syn: [
      "Plead",
      "Supplicate",
      "Entreat",
...

  {
    ...
    Longdef: "It is useless to try to settle such issues; only a bilateral agreement will resolve our disputes.",
...

  {
    ...
    Longdef: "I told Jim that he stood a very good chance of being fired, but he seemed rather blase about the whole thing.",
...

  {
    ...
    Longdef: "The CEO seems fierce; he depends largely on bluster to get his way.",
...

  {
    ...
    Longdef: "Let's treat the discovery with skepticism; after all, there are less than bona fide Vermeers known to exist.",
...

  {
    ...
    Longdef: "It appears that the dire warnings we received were nothing more than braggadocio.",
...

  {
    ...
    Longdef: "Paine's argument was stated with brevity; this simple argument won favor.",
...

  {
    ...
    Longdef: "If there is a war, rest assured that our country will be asked to bear the brunt.",
...

  {
    ...
    Longdef: "I hope you're not going to be swayed by the bugaboo that changing a design will kill a product.",
...

  {
    ...
    Longdef: "Given his capriciousness, it is not surprising Andrew never settled into one field of employment.",
    syn: [
      "Whimsical",
      "Mercurial",
      "Fickle",
...

  {
    ...
    Longdef: "Myra had shown tolerance, but after Clement's captious interrogation, she decided to leave.",
...

  {
    ...
    Longdef: "The paintings of Toulouse-Lautrec are often rooted in caricature, but are more than mere cartoons.",
...

  {
    ...
    Longdef: "His final admonition was to live life to the fullest, a carpe diem he rarely did himself.",
...

  {
    ...
    Longdef: "Jean had carte blanche as manager, but the vice president eventually supervised her more closely.",
...

  {
    ...
    Longdef: "When Roland married the daughter of a shopkeeper, he was accused of betraying his caste.",
...

  {
    ...
    Longdef: "Judge Brown's memo issued a playful catch-22: he was only to be scheduled for meetings on days out of town.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Unconcerned with what is unimportant.",
    Longdef: "I warned the CEO about his cavalier attitude and it turned out to be the company's undoing.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Latin for Buyer Beware.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Speed; swiftness of action.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Chaste; abstaining from sexual activity.",
    Longdef: "David eventually found that he could not live a life of celibacy and left the priesthood.",
    syn: [
      "abstinence",
      "chastity",
      "continence",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Confidence; personal appeal.",
...

  {
    ...
    Longdef: "The defendant, it has been claimed, is a charlatan and a liar, but where is the evidence?",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Honorable; keeping a code like medieval knights.", 
    Longdef: "Those who expected a barbarian were surprised to find me gentlemanly and quite chivalrous.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Kept hidden; secreted away.',
    Longdef: "The message reached the resistance movement by means of a coded broadcast heard on clandestine radios.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To reduce to a code.',
    Longdef: "It is high time we codify the existing maze of tax regulations.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Compelling or convincing.',
...

  {
    ...
    Longdef: "Steven was ready to give up; no amount of cogitation would yield a solution.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'An equal measure; equivalent.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Comprised of necessary components, yet concise.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Unrest; feeling of guiltiness.',
    Longdef: "I will sign her dismissal notice without compunction; she is the most incompetent salesperson.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Assembly of large number of people.',
    Longdef: "He looked around the concourse, but could not see Robin in the sea of people.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A point of meeting; flowing together.',
...

  {
    ...
    Longdef: "He found Jane a congenial hostess: easy to engage in conversation and knowledgeable.",
...

  {
    ...
    Longdef: "Your column of December 16th is based totally on conjecture, and is extremely misleading.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Related by blood; common lineage.',
    Longdef: "The two brothers learned of their consanguineous relationship after a blood test.",
...

  {
    ...
    Longdef: "The defendant's contemptuous behavior on the stand was overlooked by the judge.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Contravened',
    Pronunciation: 'kon-truh-VEEN ed',
    PartofSpeech: 'v',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Sadness over past wrong actions.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Artful means of acquiring something.',
    Longdef: "The false expense reports, a rather obvious contrivance, proved embezzlement.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Contumeliness',
    Pronunciation: 'kon-TYOO-muh-lee ness',
    PartofSpeech: 'n',
    Shortdef: 'A rude display.',
    Longdef: "No matter how long he had held the grudge, his contumeliness at the wedding was uncalled for.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Regaining one's health after an illness.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Convivial',
    Pronunciation: 'kun-VIV-ee-ul',
    PartofSpeech: 'a',
    Shortdef: 'Given to feasting and socializing.',
    Longdef: "The party was stuffy-feeling, but took on a  more convivial nature as the evening wore on.",
...

  {
    ...
    Longdef: "His argument, though perhaps sound to an expert, seemed extremely convoluted to me.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Abundant; large in extent.',
...

  {
    ...
    Longdef: "The swindler found a ready market for his wares among the credulous townsfolk.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Pertaining to preparation of food.',
    Longdef: "His expertise in the culinary arts led to a position at the city's finest restaurant.",
...

  {
    ...
    Longdef: "The six-volume set is exhaustive, but rather cumbersome. I prefer the abridged version",
    syn: [
      "bulky",
      "clumsy",
      "awkward",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Curing; Providing a remedy.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Casual romantic or sexual relationship.',
...

  {
    ...
    Longdef: "Inside the cold, dank, recesses of the cave, Fred felt terrifyingly isolated.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Licentiousness; overindulgent.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Characterized by declining morals.',
...

  {
    ...
    Longdef: "The delegates were frustrated at the chairman's move, yet strict decorum was observed in the meeting.",
...

  {
    ...
    Longdef: "The car's decrepit appearance was deceiving; Colin found it capable of doing 75 mph on the highway.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To diminish in size or extent.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "False attacks on a person's reputation.",
    Longdef: "After the last article on her your honor, Ms. Smith decided she had put up with enough defamation.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Due respect to ideas of another.',
...

  {
    ...
    Pronunciation: 'dane',
    PartofSpeech: 'v',
    Shortdef: 'To consider something beneath you.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Highly enjoyable (especially food).',
    Longdef: "The table was crammed with delectable dishes, but the news had diminished everyone's appetite.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Delineated',
    Pronunciation: 'di-LIN-ee-ate ed',
    PartofSpeech: 'v',
    Shortdef: 'To outline primary features.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Politician appealing to emotions.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Reserved and shy appearance.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Willful neglect; shirking responsibility.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Ridicule; to make light.',
    Longdef: "Our suggestions on finding a peaceful solution were met with derision by the other side.",
...

  {
    ...
    Longdef: "The phrase's derivation is unclear, but it may have its roots in an obscure tribal dialect.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To abuse a sacred characteristic.',
...

  {
    ...
    Longdef: "He eventually accepted that her love was a fleeting desideratum, one he could learn to do without.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Feeling dejected; depressed.',
...

  {
    ...
    Longdef: "Not until years after the revolution, did the General's cruel rule of despotism pass into history.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Showing or having skills.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Devilish; evil or cruel.",
    Longdef: "The terrorists, the papers claimed, had a diabolical agenda of death.",
    syn: [
      "devilish",
      "wicked",
      "satanic",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "A diagnosis. Evaulation.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Strategy of logical arguments.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'For the moral or ethical betterment.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Unassertive; lacking self-worth.',
...

  {
    ...
    SocialSituation: { ArtGallery: 'Art Gallery' },
    Word: 'Dilettantes',
    Pronunciation: 'DIL-uh-tant-es',
    PartofSpeech: 'n',
    Shortdef: 'Amateurish interest in a subject.',
    Longdef: "Once a meeting-place for true artists, it is now just full of dilettantes wanting to be artists.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Reduction from outside influences.',
    Longdef: "The stock fell in value by 75% in three hours; few issues can fully recover from such a diminution.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Relations among nations.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To treat with contempt; to dismiss.',
    Longdef: "Mark's disdain of Janet cannot be forgiven after what she said at last September's party.",
...

  {
    ...
    Longdef: "After two breakdowns, Merton suspected the used car dealer had been disingenuous with him.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Condition of being unequal.',
    Longdef: "The disparity between the two horses was obvious: one was a swayback, the other a thoroughbred.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Dissolving into fragments or parts.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Harsh combination of sounds.",
    Longdef: "I could have no peace; the city's dissonance of loud city noises poured into my apartment.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Occurring during daytime.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Departing from a given course.',
    Longdef: "The divergence in our opinions begins with the question of whether there can ever be a just war.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Adhering rigidly to a belief.',
...

  {
    ...
    Longdef: "Though she had done her best to domesticate Charles, he was still a difficult marriage partner.",
...

  {
    ...
    Longdef: "The volume was filled with droll illustrations, once I understood the point I laughed out loud.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Causing skepticism or doubt.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Overly optimistic in speech or writing.',
    Longdef: "Sharon's optimstic ebullience as she delivered the presentation set her apart from the others.",
...

  {
    ...
    Longdef: "Lionel's eccentric behavior led people in the lab avoiding him for fear of their reputations.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Variety of different sources or origins.',
...

  {
    ...
    Longdef: "The new department is lacking force, not showing results; they are considered effete.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Blossoming.',
    Longdef: "The painter's middle years were marked by remarkable and efflorescent work of unparalleled quality.",
...

  {
    ...
    Longdef: "The fiery explosion left the night sky so effulgent that Belva could not help but marvel at the display.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Belief in equality of all persons.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Selfish; one's existence is all-important.",
    Longdef: "Bill was egocentric in his family; I felt sorry for how he put himself above them.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "An individual's style of speech.",
...

  {
    ...
    Longdef: "Lincoln and Douglas, both eloquent debaters, knew that much more was at stake than a Senate seat.",
    syn: [
      "Articulate",
      "Expressive",
      "Fluent",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Difficult to perceive or describe.",
...

  {
    ...
    Longdef: "Officer, you are the embodiment of a brave man. Thank you for protecting our community.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'An agent acting for another.',
    Longdef: "The president's emissary left on a plane from Washington to present the president's proposal.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To strive to imitate.',
    Longdef: "David always felt the key to success was his decision to emulate successful people.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Warm or glowing praise.',
    Longdef: "Upon completing the scene, the actress was hailed with warm encomium from the director.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Indigenous; characteristic of a place.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Something puzzling or perplexing.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To preserve an idea.',
    Longdef: "There is a movement to enshrine Shoeless Joe Jackson in the Baseball Hall of Fame.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A thing with a distinct existence.',
...

  {
    ...
    Longdef: "He rebutted each of the charges against him with equanimity, not losing his cool.",
...

  {
    ...
    Longdef: "Elaine's erratic writing style irritated her superiors, who had no time to puzzle over an indecipherable email.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Possessing extensive knowledge on a subject.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Comprehensible only to a particular group.",
    Longdef: "The novel is likely to be enthralling if familiar with the Revolutionary War; others may find it esoteric.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To alienate from a relationship.',
    Longdef: "Her estranged brother made many attempts to visit, but Michelle would have no part in meeting.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Use of a less offensive word.',
    Longdef: "You say these are challenge times; isn't that just a euphemism for times of decreased profitability?",
...

  {
    ...
    Longdef: "There came a point when what mattered was not so much what the poet said, but his beautiful euphony of language.",
...

  {
    ...
    SocialSituation: '',
    Word: 'Expletives',
    Pronunciation: 'EK-splih-tives',
    PartofSpeech: 'n',
    Shortdef: 'Swear words; profane language.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To estimate by examining unknown values.',
    Longdef: "While there were no eyewitnesses, we can extrapolate the victim's movements based on past activities.",
...

  {
    ...
    Longdef: "I did sign the contract without consent, and presented it as a fait accompli.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Extreme attentiveness to detail.',
...

  {
    ...
    Longdef: "The islands of Hawaii suffer from an infestation of feral pigs not native to the area.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Faithfulness to duties.',
    Longdef: "The book's fidelity to the author's original version is suspect.",
...

  {
    ...
    Pronunciation: 'flont',
    PartofSpeech: 'v',
    Shortdef: 'To display in ostentatious ways.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Inexperienced. Young bird learning to fly.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Disrespectful; disregard for decorum.',
...

  {
    ...
    Pronunciation: 'fluks',
    PartofSpeech: 'n',
    Shortdef: 'Ongoing flow; unceasing change.',
...

  {
    ...
    Longdef: "Elizabeth's foray into publishing was not without disheartening moments after making several mistakes.",
...

  {
    ...
    Longdef: "The fractious political groups, with their disruptive tactics, are upsetting the balance of power.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Unworthy of serious note.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Results arisen from effort.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Displaying dashing bravery.',
...

  {
    ...
    Pronunciation: 'gohsh',
    PartofSpeech: 'a',
    Shortdef: 'Tactless; lacking in refinement.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Refined; conveying respectability.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: "To eat in a greedy manner.",
    Longdef: "Tom's tendency to gormandize at every dinner party made him an unwelcome dinner guest.",
...

  {
    ...
    Pronunciation: 'graft',
    PartofSpeech: 'n',
    Shortdef: 'Unscrupulous use of position for gain.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Being grand; extravagance.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Pompous speech or expression.',
...

  {
    ...
    SocialSituation: '',
    Word: 'Grimaced',
    Pronunciation: 'GRIM-aced',
    PartofSpeech: 'n',
    Shortdef: 'Facial expression showing discomfort.',
...

  {
    ...
    Longdef: "In laying the groundwork for embezzlement, Donald showed considerable guile and no small amount of daring.",
...

  {
    ...
    Longdef: "Oliver presented a rather hapless figure during his first few days, but he mastered his responsibilities.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Scolding delivered in a public setting.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Predominant influence in national affairs.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Professing a differing belief system.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "System ranking things one above another.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Emphasizing cooperation of the parts.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Special respect or honor.',
    Longdef: "Officer, I may have been driving a little fast, but we are in a hurry to pay homage to our grandmother.",
...

  {
    ...
    Longdef: "Colin may have been humble, but when he took over the company he showed signs of hubris.",
    syn: [
      "arrogance",
      "pride",
      "egotism",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Attacking cherished institutions or beliefs.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Entanglement; complicated misunderstanding.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Impossible to perceive through touch.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Situation that seems to offer no solution.',
...

  {
    ...
    Longdef: "The distinctions the director made are imperceptible to the average audience member, but they are there.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Demanding; impatient in issuing repeated requests.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Act on incorrectness given the situation.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To brand as false in argument.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Embodied; taking shape of something.',
...

  {
    ...
    Longdef: "His incessant questions can become quite annoying. I thought he would never shut up.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Harsh; refers to extreme weather",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To instill by means of instruction.',
...

  {
    ...
    Longdef: "Betty, an indefatigable runner, never slowed her pace until she crossed the finish line.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Sluggishness; tendency to stay at rest.',
...

  {
    ...
    Longdef: "My opponent's failure to file income tax returns is inexplicable as a candidate for Congress.",
...

  {
    ...
    Longdef: "You have no need to worry about the security of this mission; the HAL 9000 computer is infallible.",
...

  {
    ...
    Longdef: "Dwayne's inherent reluctance to entrust newcomers with tasks of any significance was a problem.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Harmless; lacking conflict or drama.',
    Longdef: "The editor rejected my news story, which I found fascinating but he considered innocuous.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Opening to a new idea.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Failing to obey authority',
...

  {
    ...
    Longdef: "The insurgence against the dictator's regime was welcomed by the country's farmers as it could lead to a new government.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'An essential member of the whole.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Uncompromising; determined to one's position.",
...

  {
    ...
    Longdef: "The intrinsic value of gold was one of the few economic factors of which the nations could take advantage.",
...

  {
    ...
    Longdef: "The weekend at the cabin provided Clive with an opportunity for much-needed introspection.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Authority of a court of law.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "A prime theme; underlying element.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Lustful; strong sexual desire.',
...

  {
    ...
    Longdef: "Paul's latent musical abilities were one of the main reasons he started the classical music club.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Sluggish; apathetic.',
    Longdef: "Pat and Corey stared at each other lethargically but unable to accept the necessity of calling it a night.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Alcohol offered in celebration.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Incessant in an unwavering manner.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Inclined to engage in lawsuits.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Th details of an operation',
...

  {
    ...
    Longdef: "Michael proved a loquacious houseguest; Stan did his best to manage his talkative nature.",
    syn: [
      'talkative',
      'chatty',
      'garrulous',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Absurd to being laughable.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Large scale representation.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'The undertaking of harmful acts.',
    Longdef: "The long-ignored maleficence of the corrupt prison system was finally exposed by a rookie reporter.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Posing a serious threat.',
...

  {
    ...
    Longdef: "It is best to go over the company's sick leave policy on the employees' first day; people are more malleable.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Insane; overly emphatic.',
...

  {
    ...
    Longdef: "The tycoon's purchase of the castle was a bad real estate deal; it was pure megalomania.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A transformation; undergoing change.',
    Longdef: "Daryl's friends viewed his entry into politics with concern; they feared his metamorphosis into a militant.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Model that reflects a larger thing.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Difficult to move; huge or massive.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Frightening or gloomy.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "Of diverse composition; displaying many colors.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Made of many components.',
...

  {
    ...
    Pronunciation: 'MYOOZ',
    PartofSpeech: 'v',
    Shortdef: 'To meditate about a topic.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Emerging; early stages of existence.',
...

  {
    ...
    Longdef: "The party's nebulous political doctrines were difficult for Judy to comprehend.",
...

  {
    ...
    Longdef: "To what nefarious end has this information been withheld from the public.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Favoritism toward relatives.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Lower; beyond the normal point.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A state of spiritual perfection.',
...

  {
    ...
    Longdef: "A sense of noblesse oblige, not desire for headlines, motivates the Beal family's tradition of giving and volunteerism.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A system of names in an organization.',
...

  {
    ...
    Longdef: "Astaire's nonchalance was appealing to the audience of the time, which was weighted down with the Great Depression.",
...

  {
    ...
    Longdef: "You may safely regard this clause of the contract as a nonenity; it is obsolete and completely unenforceable.",
...

  {
    ...
    Longdef: "The prosecution has put up with attempts to obfuscate, and muddy the issues of the case, your Honor?",
...

  {
    ...
    Longdef: "The coaches, who hated each other, nevertheless exchanged the obligatory handshakes at the game.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Reference leaving listener unclear',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Beyond memory and utterly forgotten.',
    Longdef: "The fact that his book had gone out of print meant that as an author he had been consigned to oblivion.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Not mindful. Unawareness.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Unyielding.',
    Longdef: "Melvin, obstinate to the end, refused to talk about settling the case.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Not sharp; unintelligent',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Long journey of adventure.',
    Longdef: "The film Easy Rider recounts the odyssey of two motorcyclist exploring America.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Offering assistance when unwanted.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Foreboding; foretelling harm.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'All-knowing; absolute knowledge.',
    Longdef: "Contrary to what you may have heard, Professor Powers is not omniscient; he still has a thing to learn.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Burden of a task or duty.',
...

  {
    ...
    Longdef: "Karl was unable to make out exactly what was happening behind the opaque screen in front of him.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'A great show of wealth.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Attaining knowledge by gradual exposure.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'An example; ideal pattern.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A peerless model of perfection.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'An outburst; sudden action.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Stingy.',
    Longdef: "The old man's parsimonious ways were legend: it is said in restaurant dining, he never picked up a check.",
...

  {
    ...
    Longdef: "William is so pedantic; around the office he has a reputation as an intellectual showoff.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Enduring; lasting indefinitely.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Mundane; showing little interest.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Causing insidious harm or injury.',
...

  {
    ...
    Longdef: "Gordon was persnickety about meals; breakfast was always served at exactly 7:05 am and dinner at 6:55 pm.",
...

  {
    ...
    Longdef: "The problem was complex and required  analysis of someone with great perspicacity and wisdom.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Infiltrated; widely circulated.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'A striking or interesting scene.',
...

  {
    ...
    Pronunciation: 'Peek',
    PartofSpeech: 'v',
    Shortdef: "To injure a person's pride.",
    Longdef: "Marcia was piqued at not having been invited to the party.",
...

  {
    ...
    Longdef: "The speech seemed quite promising but you filled it with platitudes and the audience will lose interest.",
...

  {
    ...
    Longdef: "The TV host's greatest asset was his skill in polemics, getting his guests to argue hard for their side.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Past example that should be followed.',
...

  {
    ...
    Longdef: "Though the view is spectacular, I don't advise walking near the precipice.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Intellectually gifted child.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Action before others can take action.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Pretending; to falsely act surprised.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: "To lie; avoid revealing the truth.",
...

  {
    ...
    Longdef: "Harry had always been prodigal with this greeting card mailings, hoping that it would help his business.",
    syn: [
      "Spendthrift",
      "Extravagant",
      "Wasteful",
...

  {
    ...
    Longdef: "The liberal Governor's retirement is a severe blow to the progressive movement.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To multiply by natural processes.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Commonplace; matter-of-fact.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Someone taught by an influential person.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Formal etiquette in diplomacy.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: "A parallel with a well-known story.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Exercising care; carefully considered.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'To follow overly moralistic standards.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Reputed or regarded by common assent.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Entanglement offering no means of escape.',
    Longdef: "The hostage situation, which worked in the President's favor, now threatens to become his worst quagmire.",
...

  {
    ...
    Pronunciation: 'kwalm',
    PartofSpeech: 'n',
    Shortdef: 'A misgiving; pang of conscience.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Rejection or disapproval.',
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: "To act in turn following another's.",
...

  {
    ...
    Longdef: "How is the White House to reconcile these conflicting signals from the Kremlin?",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To search to gain information.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Superfluous; filling role already complete.',
...

  {
    ...
    PartofSpeech: 'v/n',
    Shortdef: 'To express stern disapproval',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Disgust; strong aversion.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Unyielding; firm in purpose.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Reserved; preferring silence.',
...

  {
    ...
    Longdef: "Some saw the mafia don's debilitating illness as a form of divine retribution for a life of violent crime.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Point beyond which change is possible.',
    Longdef: "In signing the bill, the Governor crossed the Rubicon and closed the door on his prison reform.",
    syn: [
      "point of no return",
      "threshold",
      "boundary",
...

  {
    ...
    Longdef: "Grover Cleveland was elected to the White House twice, but the salient point is that in 1888, he was defeated.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A person blamed for a mishap.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Insights or luck by accident.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A convincing argument but logically flawed.',
...

  {
    ...
    Longdef: "There were many in the academic community ready to accept the spurious manuscripts as coming from Shakespeare.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: "Chess game with no winner.",
...

  {
    ...
    Longdef: "The will features one important stipulation: you must wait until you are 30 to receive the money.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Disdainful; overbearingly proud.',
...

  {
    ...
    Longdef: "These forms, which supersedes the old versions, has been made much easier to read and fill out.",
    syn: [
      "Replace",
      "Override",
      "Displace",
...

  {
    ...
    Longdef: "It was only with the surcease of hostilities that life began to be normal for the civilian population.",
...

  {
    ...
    Longdef: "Our conference room has been fitted with 'bugs' to monitor our conversations surreptitiously.",
...

  {
    ...
    Longdef: "You must understand that Betty can be quite taciturn; her silence is not because of anything you have done.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Equivalent in all meaningful respects.',
    Longdef: "Since this is a tight race, a vote for the third party candidate is tantamount to a vote for my opponent.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Unnecessary repetition; already stated idea.',
    Longdef: "Your description of Brian as a 'foreign illegal' is a tautology.",
...

  {
    ...
    Longdef: "The claim I would institute some sort of technocracy because I am a skilled manager ignores my years as a District Attorney.",
...

  {
    ...
    Longdef: "The general warned that the troops' position was no longer tenable, preparations should be made to evacuate.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Pleasant or appealing (taste).',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Beyond realm of normal experience.',
    Longdef: "The astronauts reacted in different ways to the transcendental experience of space travel.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Allowing light to show through.',
...

  {
    ...
    Longdef: "I take umbrage at the suggestion that I have used my position for illicit personal gain.",
...

  {
    ...
    PartofSpeech: 'v',
    Shortdef: 'To criticize and assign blame.',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Bearlike; Latin for bear.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Unexpected turn of events.',
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'Most advanced groups (of military force).',
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Strongly felt; marked by high emotion.',
    Longdef: "Congress overrode the President's veto after expressing their vehement dissatisfaction with his policy.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Dignified; worthy of admiration.',
...

  {
    ...
    Longdef: "The cardboard boxes contained a veritable treasure trove of Civil War artifacts, worth thousands of dollars.",
...

  {
    ...
    PartofSpeech: 'n',
    Shortdef: 'A remaining sample; something no longer common.',
...

  {
    ...
    Longdef: "The novel doesn't quite work. The characters are saucy and vivacious, but the situations are deadly dull.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Potentially unstable; likely to shift.',
    Longdef: "We should have known that asking those two to work together would lead to a volatile environment.",
...

  {
    ...
    PartofSpeech: 'a',
    Shortdef: 'Greedily hungry; large appetite.',
...

  {
    ...
    Longdef: "My grandfather, like many men of his generation, spent time as a wayfaring laborer during the depression.",
